...
$query = mysqli_query($connection,"insert into monthlycar_cleaning(Name, Mobile, Date_time, Car_type, Seat_type) values ('$name', '$mobile', '$datetimepicker', '$cartype', '$seattype')");
